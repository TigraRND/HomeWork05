...
Berserk и Knight - классы описывают кокретные юниты, которые отличаются силой наносимого урона и имеют метод атаки где сила атаки вычисляется путем умножение силы юнита на урон выбранного юнитом оружия.
